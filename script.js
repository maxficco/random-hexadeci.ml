...
function searchfunc1() {
  if (document.getElementById("text1").innerHTML == "(Click the hex codes to get a new color!)") {
    
  } else {
    window.open("https://www.google.com/search?q=" + document.getElementById("text1").innerHTML + " color", "_blank");
  }
  
};
function searchfunc2() {
  if (document.getElementById("text2").innerHTML == "(Or, press space for a random palette!)") {
    
  } else {
    window.open("https://www.google.com/search?q=" + document.getElementById("text2").innerHTML + " color", "_blank");
  }
  
};
function searchfunc3() {
  if (document.getElementById("text3").innerHTML == "Share your palette with a custom link!)") {
    
  } else {
    window.open("https://www.google.com/search?q=" + document.getElementById("text3").innerHTML + " color", "_blank");
  }
